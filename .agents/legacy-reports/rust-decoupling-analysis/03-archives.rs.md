...
- **Responsibilities:**
  ...
  - [`extract_tar_to_temp`](file:///E:/Projects/QuiviT/src-tauri/src/archives.rs#L553-L593): Decompresses TAR into temp directory so subsequent random page access is fast from disk.
