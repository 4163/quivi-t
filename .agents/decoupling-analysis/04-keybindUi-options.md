...
**Highest-leverage targets:** (1) shared keybind domain module; (2) shared theme/CSS preview module (+ emergency reset, preview preservation); (3) shared gesture primitives in shortcuts.js; and restoring core.js purity by moving theme application out.